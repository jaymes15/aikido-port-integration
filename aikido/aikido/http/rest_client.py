...
class RestClient:
    ...
    async def get(self, url: str, params: Optional[Dict[str, Any]] = None, token: Optional[str] = None) -> httpx.Response:
        ...
        try:
            ...
            logger.debug(f"[RestClient] GET {full_url} status={response.status_code} body={response.text[:300]}")
            return response
    ...
    async def post(self, url: str, json: Optional[Dict[str, Any]] = None, token: Optional[str] = None) -> httpx.Response:
        ...
        try:
            ...
            logger.debug(f"[RestClient] POST {full_url} status={response.status_code} body={response.text[:300]}")
            return response
        except Exception as e:
    ...
    async def put(self, url: str, json: Optional[Dict[str, Any]] = None, token: Optional[str] = None) -> httpx.Response:
        ...
        try:
            ...
            logger.debug(f"[RestClient] PUT {full_url} status={response.status_code} body={response.text[:300]}")
            return response
        except Exception as e:
    ...
    async def delete(self, url: str, token: Optional[str] = None) -> httpx.Response:
        ...
        try:
            ...
            logger.debug(f"[RestClient] DELETE {full_url} status={response.status_code} body={response.text[:300]}")
            return response
        except Exception as e:
